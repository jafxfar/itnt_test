<template>
    <div class="flex flex-col items-stretch">
        <Header showUserMinify :routeName="'Евгений Анисимов'" />
        ...
        <div class="input">
            <div class="input-container">
                <input class="pl-[16px] outline-none w-full" type="text" v-model="currentMessage"
                    placeholder="Hey..." @keypress.enter="sendMessage(currentMessage)">
...
onMounted(() => {
    ...
    socket.on('receive_message', (data) => {
        ...
        messageList.value.push(data); // Добавьте полученное сообщение в messageList
    })
})
